...
namespace TollBooth
{
    public class FindLicensePlateText
    {
        ...
        private async Task<string> MakeOCRRequest(byte[] imageBytes)
        {
            ...
            // https://tollboothcomputervisionha.cognitiveservices.azure.com/vision/v3.2/ocr?language=unk&detectOrientation=true
            var uri = uriBase + "vision/v3.2/ocr?" + requestParameters;
            _log.LogInformation($"Making OCR request to {uri}");
